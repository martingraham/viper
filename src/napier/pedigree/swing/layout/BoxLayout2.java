...
/**
 * Adaptation of BoxLayout to stop components expanding to fill available space
 * Couldn't extend BoxLayout and just change the method I needed to as it's full of 
 * private variables, package-protected methods and calls static methods of another 
...
public class BoxLayout2 implements LayoutManager2, Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3042925365420580307L;
     ...
     */
    public BoxLayout2 (Container target, int axis) {
     ...
     *   null if none
     */
    BoxLayout2 (Container target, int axis, PrintStream dbg) {
        this(target, axis);
        this.dbg = dbg;
    }
	...
	synchronized(this) {
	    ...
	    // The only 2 changes I needed to do was to call SizeRequirements2 static methods
	    // and I had to copy the whole class to do it
	    if (absoluteAxis == X_AXIS) {
		SizeRequirements2.calculateTiledPositions(alloc.width, xTotal,
							 xChildren, xOffsets,
							 xSpans, ltr);
		...
		SizeRequirements.calculateAlignedPositions(alloc.width, xTotal,
							   xChildren, xOffsets,
							   xSpans, ltr);
		SizeRequirements2.calculateTiledPositions(alloc.height, yTotal,
							 yChildren, yOffsets,
							 ySpans);
	    }
	}
